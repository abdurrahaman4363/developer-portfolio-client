        ...
        <div className='grid  sm:grid-cols-1 lg:grid-cols-3 gap-4 px-10'>
            ...
            <div class="card card-compact w-96 bg-base-100 shadow-xl">
                ...
                <div class="card-body">
                    ...
                    <div class="card-actions justify-center">
                       ...
                       <Link to="/projectOne"><button class="btn btn-primary">Project Details</button></Link>
                ...
                <div class="card-body">
                   ...
                   <h1 className='text-black font-bold text-xl'>To know more about my project click the button</h1>
                    ...
                    <a href="https://warehouse-assignment-11.web.app/"><button class="btn btn-primary">Live Site</button></a>
                       ...
                       <Link to="/projectTwo"><button class="btn btn-primary">Project Details</button></Link>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-compact w-96 bg-base-100 shadow-xl">
                ...
                <div class="card-body">
                    ...
                    <Link to="/projectThree"><button class="btn btn-primary">Project Details</button></Link>
